...
//        scrPane.setBorder(new EmptyBorder(0, 0, 0, 0));
        ...
        listitem[0].addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent evt) {
                th = new ThuongHieuDialog(owner, QuanLyThuocTinhSP.this, "Quản lý thương hiệu", true,m.user.getManhomquyen().getId(), m);
                th.setVisible(true);
            }
        });
        listitem[1].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                xs = new XuatXuDialog(owner, QuanLyThuocTinhSP.this, "Quản lý xuất xứ sản phẩm", true,m.user.getManhomquyen().getId());
                xs.setVisible(true);
            }
        });
        listitem[2].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                hdh = new HeDieuHanhDialog(owner, QuanLyThuocTinhSP.this, "Quản lý hệ điều hành", true,m.user.getManhomquyen().getId());
                hdh.setVisible(true);
            }
        });
        ...
        listitem[3].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                dlram = new DungLuongRamDialog(owner, QuanLyThuocTinhSP.this, "Quản lý dung lượng RAM", true,m.user.getManhomquyen().getId());
        ...
        listitem[4].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                dlrom = new DungLuongRomDialog(owner, QuanLyThuocTinhSP.this, "Quản lý dung lượng ROM", true,m.user.getManhomquyen().getId());
        ...
        listitem[5].addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent evt) {
                mausac = new MauSacDialog(owner, QuanLyThuocTinhSP.this, "Quản lý màu sắc", true,m.user.getManhomquyen().getId());
