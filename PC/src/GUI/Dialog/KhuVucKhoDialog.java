...
public final class KhuVucKhoDialog extends JDialog implements ActionListener {
    ...
    public KhuVucKhoDialog(KhuVucKho jpkvk, JFrame owner, String title, boolean modal, String type, WareHouse kvk) {
        super(owner, title, modal);
        this.jpkvk = jpkvk;
        this.kvk = kvk;
        initComponents(title, type);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnThem && Validation()) {
            ...
            ware.addPhone(new ListTransfer("add",new WareHouse(tenkhuvuc,ghichu,1)));
            jpkvk.listKVK= conn.findAll().getListWare();
            ...
            String tenkhuvuc = this.tenkhuvuc.getText();
            String ghichu = this.ghichu.getText();
            ware.addPhone(new ListTransfer("add",new WareHouse(kvk.getId(),tenkhuvuc,ghichu,1)));
            jpkvk.listKVK= conn.findAll().getListWare();
            jpkvk.loadDataTable(jpkvk.listKVK);
            dispose();
        }
