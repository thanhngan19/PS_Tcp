...
class ShadowRendererNotification {
    ...
    public ShadowRendererNotification() {
        this(5, 0.5f, Color.BLACK);
    }

    public ShadowRendererNotification(final int size, final float opacity, final Color color) {
        this.size = size;
    ...
    public BufferedImage createShadow(final BufferedImage image) {
        ...
        GraphicsUtilitiesNotification.getPixels(image, 0, 0, srcWidth, srcHeight, srcBuffer);
        ...
        GraphicsUtilitiesNotification.setPixels(dst, 0, 0, dstWidth, dstHeight, dstBuffer);
        return dst;
    }
}
